...
class DataArguments:
    ...
    vloc: bool = field(default=False, metadata={"help": "Only stage 3."})
    random_drop: bool = field(default=False, metadata={"help": "whether to random filter."})
    need_KL: bool = field(default=False, metadata={"help": "whether to use KL."})
    ce_loss: str = field(default="positive_only", metadata={"help": "The strategy for CE loss. Choices: ['positive_only', 'negative_only', 'double']"})
    random_cut: bool = field(default=False, metadata={"help": "whether to randomly cut some pixels."})
    attention_drop:bool = field(default=False, metadata={"help": "whether to randomly ignore some tokens."})